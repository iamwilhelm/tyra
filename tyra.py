...
class Tyra:
    ...
    def lookup(self, searchstr):
        ...
        [{'dim': 'oil|production', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption`heat', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption`kill', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption`motor', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|total', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}]
        >>> print tyra.lookup('oil')
        [{'dim': 'oil|production', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption`heat', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption`kill', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption`motor', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|total', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}]
        >>> print tyra.lookup('Gold')
        []
        >>> print tyra.lookup('heat')
        [{'dim': 'oil|consumption`heat', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}]
        >>> print tyra.lookup('consumption')
        [{'dim': 'oil|consumption`heat', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption`kill', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'oil|consumption`motor', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}]
        >>> print tyra.lookup('Pygmy')
        [{'dim': 'whales|pygmy_whale', 'source_name': 'fake', 'description': 'Whale Population', 'default': 'State', 'url': 'http://www.graphbug.com/fakedata_whales.csv', 'publish_date': '1985', 'units': 'Animals'}]
        >>> print tyra.lookup('pygmy')
        [{'dim': 'whales|pygmy_whale', 'source_name': 'fake', 'description': 'Whale Population', 'default': 'State', 'url': 'http://www.graphbug.com/fakedata_whales.csv', 'publish_date': '1985', 'units': 'Animals'}]
        >>> print tyra.lookup('Banks')
        [{'dim': 'number_of_banks', 'source_name': 'fake', 'description': 'Total Number of Banks by year', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_banks.csv', 'publish_date': '1980', 'units': 'Buildings'}]
        >>> print tyra.lookup('hump heat')
        [{'dim': 'oil|consumption`heat', 'source_name': 'fake', 'description': 'Info about oil', 'default': 'Year', 'url': 'http://www.graphbug.com/fakedata_oil_1995.csv', 'publish_date': '1995', 'units': 'Barrels'}, {'dim': 'whales|humpback_whale', 'source_name': 'fake', 'description': 'Whale Population', 'default': 'State', 'url': 'http://www.graphbug.com/fakedata_whales.csv', 'publish_date': '1985', 'units': 'Animals'}]
        """
        ret = []
