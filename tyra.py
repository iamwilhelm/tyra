...
class Tyra:
    ...
    def getData(self, dimension, xAxis=None, xAxisLabels=None, zAxis=None):
        ...
        {'source': ['The Fed'], 'xAxis': 'Year', 'units': 'Buildings', 'xAxisLabels': ['1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992'], 'data': ['5154.87231', '5149.45502', '5146.63868', '5152.8723', '5153.36446', '5153.18858', '5157.43476', '5152.97737', '5154.32464', '5149.66505', '5156.04165', '5152.08343', '5154.48629'], 'dimension': 'Banks'}
        >>> print tyra.getData('Oil|Production')
        {'source': ['Oil Companies'], 'xAxis': 'Year', 'units': 'Barrels', 'xAxisLabels': ['1995', '1996', '1997', '1998', '1999', '2000'], 'data': ['2592.86774', '2562.55721', '2536.98437', '2506.7974', '2478.74694', '2450.37708'], 'dimension': 'Oil|Production'}
        >>> print tyra.getData('Oil|Production', 'State', ['Alabama', 'Arizona', 'Alaska'])
        {'source': ['Oil Companies'], 'xAxis': 'State', 'units': 'Barrels', 'xAxisLabels': ['Alabama', 'Arizona', 'Alaska'], 'data': ['None', 'None', 'None'], 'dimension': 'Oil|Production'}
        ...
        {'source': ['The Fed'], 'xAxis': 'Year', 'units': 'Buildings', 'xAxisLabels': ['1980', '1981', '1982'], 'data': ['5154.87231', '5149.45502', '5146.63868'], 'dimension': 'Banks'}
        >>> print tyra.getData('Peanut_Butter|PBJ', None, ['Alabama', 'Arizona', 'Alaska'])
        {'source': ['Jiffy'], 'xAxis': 'State', 'units': 'Tons', 'xAxisLabels': ['Alabama', 'Arizona', 'Alaska'], 'data': ['1015.3908', '1016.88395', '1011.80846'], 'dimension': 'Peanut_Butter|PBJ'}
        """
